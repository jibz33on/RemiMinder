"""
Simple fact extraction prompt for medical visit transcripts.

Extracts basic facts from transcript. Keep it simple for experimentation.
"""
...
{{
  "symptoms": [
    {{
      ...
      "severity": "severity level or 'Not mentioned in transcript'"
    }}
  ],
  "diagnosis": {{
